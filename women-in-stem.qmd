...
- In [previous research](https://github.com/lgibson7/Gender-Wage-Inequality-in-STEM), I used **multiple linear regression (MLR)** to explore the the relationship between gender demographics and median salary of STEM major categories. 

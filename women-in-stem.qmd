...
p3 <-lindia::gg_boxcox(lm_full) + ggtitle("Box Cox Plot for Full Model")
...
```{r}
performance::compare_performance(lm_reduced, lm_full)
```
...
- I would like to thank the FiveThirtyEight blog for uploading the data behind the story [*The Economic Guide To Picking A College Major*](https://fivethirtyeight.com/features/the-economic-guide-to-picking-a-college-major/), which was used for this analysis.

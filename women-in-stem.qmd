...
- The final model used the inverse transformation of the response variable to improve the fit of the regression model, then ran model diagnostics to assess the fit of our model.
...
- In this project, I will compare multiple linear regression models using both **with** a inverse transformation dependent response variable and the other **without** a inverse transformation dependent response variable.
